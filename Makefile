...
class-diagram: ## generate a class-diagram with pyreverse
	...
	pyreverse -o plantuml --verbose --colorized --ignore=restaurant_repository_test.py --ignore=view_test.py --ignore=service_test.py --ignore=menu_repository_test.py --ignore=repository_test_helpers.py --ignore=reservation_repo_test.py --ignore=table_repo_test.py -p restaurant_app -d ./doc ./src/restaurant_app
